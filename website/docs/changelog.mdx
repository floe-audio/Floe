...
### Misc
- Change performance controls icon from 'sliders' to 'gauge'. The old icon didn't look very good and was a little confusing due to ambiguity with the Preferences button and that it didn't actually feature any sliders.
