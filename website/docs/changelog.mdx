...
- Preset banks can suggest a default preset with a new `default_preset` key in `floe-preset-bank.ini`. Installing a package containing such a bank applies the suggestion unless you've chosen your own default
