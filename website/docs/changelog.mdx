...
# Changelog
## 2.0.0
Major update. Includes all changes from 1.2.0-beta.1 and 2.0.0-beta.1 through to 2.0.0-beta.6. Changes since beta 6:
...
- Package CLI: change to subcommand format: info or pack.
