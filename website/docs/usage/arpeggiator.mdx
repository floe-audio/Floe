...
- **Gate** (small knob): the proportion of the step duration that the note actually sounds for. 100% is legato; lower values create staccato patterns.
