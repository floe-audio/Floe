...
description: Information about Floe sample libraries
---
...
- [How to install libraries](/docs/packages/install-packages)
- [Develop your own libraries](/docs/develop/develop-libraries) (programming required)

_Floe also supports the legacy [Mirage](/docs/about-the-project/mirage) library format_.
...
You can view your installed libraries by clicking the <FAIcon icon="fa-solid fa-info-circle" /> info button on Floe's main window.
