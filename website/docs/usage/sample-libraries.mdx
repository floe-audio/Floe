...
- [How to install libraries](../packages/install-packages)
- [Develop your own libraries](../develop/develop-libraries) (programming required)

_Floe also supports the legacy [Mirage](../about-the-project/mirage) library format_.
