...
<GeneratedScreenshot name="folders" alt="Folder Preferences GUI" />
...
If you're not yet familiar with what a sample library or preset is, read more about these concepts on the [glossary](../getting-started/glossary) page.
