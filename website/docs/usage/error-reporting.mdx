...
description: How Floe handles error reporting and feedback
---
...
## Send feedback
Floe has a form that you can use to submit bug reports, feature requests, or general feedback. This is found by clicking on the 'Send Feedback' button in the <FAIcon icon="fa-solid fa-ellipsis-v" /> three-dots menu at the top of Floe's window.
