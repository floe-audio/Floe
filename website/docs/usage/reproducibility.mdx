...
- These settings belong to this specific instance of Floe rather than being a global preference, and they are saved with your DAW session. Different instances in the same project can use different settings.
