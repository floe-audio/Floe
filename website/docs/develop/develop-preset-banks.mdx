...
Floe's preset management is based around simple files stored in folders.

Developing preset banks is simply a matter of saving preset files into a folder and then packaging them into a [Floe Package](/docs/develop/packaging).
