...
We're open to discuss sponsorship for aspects such as: priority support, submissions to our [Package Directory](/packages), and creating/converting sample libraries to Floe.

Please get in touch with [Sam](mailto:sam@frozenplain.com).
