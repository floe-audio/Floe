...
First, [install Floe](../installation/download-and-install-floe) and open it in your DAW.

Download your chosen [package(s)](./about-packages) (ZIP files containing sample libraries and presets). **Don't extract them.**
