...
### How to update
To update Floe, simply [download and run the latest installer](/download). It will replace the old version in a backwards-compatible way — your DAW projects won't break.
