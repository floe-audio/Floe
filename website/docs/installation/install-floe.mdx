...
When a newer version is available, a red dot will appear on the <FAIcon icon="fa-solid fa-ellipsis-v" /> 3-dots menu in Floe's window.

<GeneratedScreenshot name="update-indicator" alt="Floe red dot update indicator" />
...
<GeneratedScreenshot name="check-for-updates" alt="Floe info panel update info" />
