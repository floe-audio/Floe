...
### Delete Mirage
If you used to have [Mirage](/docs/about-the-project/mirage) installed then some additional files may be present. To uninstall Mirage, delete the following files. Some of these files may not exist.
