...
1. **[Download packages](/packages)** of your choice.
1. **Open your DAW**.
1. **Add the Floe plugin** - often found under 'Floe Audio' in your plugin list.
1. **Install your packages** by opening the Preferences <FAIcon icon="fa-solid fa-cog" /> and clicking the **Install package** button.
1. **Select your downloaded package** ZIP file(s). After a few moments, your libraries and presets will be available to use.

## Load a preset

Let's now make some sounds:
...
A _Preset_ is a full setup of all of Floe's sounds and parameters.
...
Instruments are the building blocks of sounds in Floe. Sometimes an instrument is a single sample, sometimes it's a detailed multi-sampled emulation of a real instrument.
