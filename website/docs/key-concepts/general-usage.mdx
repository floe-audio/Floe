...
Simply grab the bottom-right corner of the window (the 2 small diagonal 'grabber' lines) and drag to resize it. ![Resize corner](/images/resize-corner.png)
...
## MIDI control
Setup Floe to work with your MIDI controller by following the instructions on the [MIDI](../usage/midi) page.
