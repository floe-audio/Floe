...
## Resizing the window
Floe's window is fully resizable. It's locked to the aspect ratio of the design, so resizing it scales everything proportionally to whatever scale you choose.
