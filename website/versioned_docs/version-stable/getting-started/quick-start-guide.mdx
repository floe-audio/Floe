...
If you already have packages (perhaps sent to your email), begin _Setting up Floe_. Otherwise, browse the [packages](/packages) page first to discover free and paid options.
