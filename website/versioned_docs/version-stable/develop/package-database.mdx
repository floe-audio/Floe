...
All packages must be compatible with the current Floe version and meet basic quality standards for audio, scripting, and presentation. Packages from larger-budget developers/studios may require [sponsorship](../about-the-project/sponsorship.mdx).
...
**Professional** - High-quality libraries from established developers/studios. May be free or paid. [Requires project sponsorship](../about-the-project/sponsorship).
