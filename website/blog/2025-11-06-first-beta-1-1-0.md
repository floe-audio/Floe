...
See the new [comprehensive usage page for the browsers](/docs/beta/usage/browsers) that explains all the features in detail.
...
- [Glossary](/docs/beta/getting-started/glossary): understand key parts of Floe such as packages, libraries, and presets.
- [Folders](/docs/beta/usage/folders): expanded and improved explanations of Floe's folders for libraries and presets.
- [Core usage tips](/docs/beta/getting-started/overview): tips and general usage tips for using Floe effectively.
