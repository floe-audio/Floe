...
The installation documentation has been restructured too, with clearer instructions for [installing Floe](/docs/installation/install-floe), [installing packages](/docs/installation/install-packages), and [uninstalling](/docs/installation/uninstalling).
