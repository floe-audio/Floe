...
You can also read the [comprehensive usage documentation for the browsers](/docs/usage/browsers) which explains all features.
...
- [Components](/docs/getting-started/glossary): Understanding packages, libraries, and presets
- [Folders](/docs/usage/folders): Where Floe stores its files and how to manage them
- [Browsers](/docs/usage/browsers): Complete guide to finding and selecting sounds
- [General usage tips](/docs/getting-started/overview): Best practices for working with Floe
