        ...
        [
            '@docusaurus/plugin-client-redirects',
            {
                ...
                redirects: [
                    ...
                    { to: '/docs/usage/components', from: ['/docs/usage/presets', '/usage/presets', '/usage/presets.html', '/docs/usage/sample-libraries', '/usage/sample-libraries', '/usage/sample-libraries.html', '/docs/packages/about-packages', '/packages/about-packages', '/packages/about-packages.html'], },
