...
-   12 effects in a reorderable rack
-   Powerful [granular synthesis](/docs/beta/usage/granular)
-   Per-layer [arpeggiator](/docs/beta/usage/arpeggiator)
-   Comprehensive [browsers](/docs/beta/usage/browsers) for finding the right sound or preset
-   [Random variation generator](/docs/beta/usage/randomisation)
-   CPU efficient
-   Resizable UI
...
2.  **Main content** — showing the background image of the sample library, with one of 3 selectable tabs: [_Perform_](/docs/beta/usage/perform) shows the distraction-free basic view, [_Layers_](/docs/beta/usage/layers) exposes the per-layer parameters for each of the three layers, and [_Effects_](/docs/beta/usage/effects) is the reorderable effects rack.
...
-   Hovering over a control shows its current value straight away. Pause on it for a moment and a brief description appears alongside. These descriptions can be disabled in the preferences panel.
