...
The **Performance Controls** panel (sliders icon, top panel) is where you manage everything about how Floe responds to a live performance: [MIDI CC mappings](/docs/beta/usage/midi#midi-cc), [MPE](/docs/beta/usage/midi#mpe), and [Reproducibility](/docs/beta/usage/reproducibility) settings.
...
-   Floe defaults with some common MIDI CC assignments, such as the mod wheel (CC1) to the first macro — [more info](/docs/beta/usage/midi).
