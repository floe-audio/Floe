...
| Layer 1/Config | MPE Press Target | 256 | L1 MPE Press Target | What MPE 'press' (per-note channel pressure) controls on this layer. Only active when MPE is enabled in Performance Controls |
| Layer 1/Config | MPE Press Amount | 257 | L1 MPE Press Amount | Intensity of the MPE press effect; negative values invert it. Beyond 100%, the full effect is reached with a smaller gesture |
| Layer 1/Config | MPE Slide Target | 258 | L1 MPE Slide Target | What MPE 'slide' (per-note CC74) controls on this layer. For Volume, the slide position acts as a fader up to the layer's volume level; other destinations are bipolar around slide's centre. Only active when MPE is enabled in Performance Controls |
| Layer 1/Config | MPE Slide Amount | 259 | L1 MPE Slide Amount | Intensity of the MPE slide effect; negative values invert it. Beyond 100%, the full effect is reached with a smaller gesture |
| Layer 1/LFO | Time (Tempo Synced) | 260 | L1Lfo Time (Tempo Synced) | LFO rate (synced to the host) |
| Layer 1/Arp | Rate | 261 | L1Arp Rate | Arpeggiator rate (synced to host tempo) |
...
| Layer 2/Config | MPE Press Target | 416 | L2 MPE Press Target | What MPE 'press' (per-note channel pressure) controls on this layer. Only active when MPE is enabled in Performance Controls |
| Layer 2/Config | MPE Press Amount | 417 | L2 MPE Press Amount | Intensity of the MPE press effect; negative values invert it. Beyond 100%, the full effect is reached with a smaller gesture |
| Layer 2/Config | MPE Slide Target | 418 | L2 MPE Slide Target | What MPE 'slide' (per-note CC74) controls on this layer. For Volume, the slide position acts as a fader up to the layer's volume level; other destinations are bipolar around slide's centre. Only active when MPE is enabled in Performance Controls |
| Layer 2/Config | MPE Slide Amount | 419 | L2 MPE Slide Amount | Intensity of the MPE slide effect; negative values invert it. Beyond 100%, the full effect is reached with a smaller gesture |
| Layer 2/LFO | Time (Tempo Synced) | 420 | L2Lfo Time (Tempo Synced) | LFO rate (synced to the host) |
| Layer 2/Arp | Rate | 421 | L2Arp Rate | Arpeggiator rate (synced to host tempo) |
...
| Layer 3/Config | MPE Press Target | 576 | L3 MPE Press Target | What MPE 'press' (per-note channel pressure) controls on this layer. Only active when MPE is enabled in Performance Controls |
| Layer 3/Config | MPE Press Amount | 577 | L3 MPE Press Amount | Intensity of the MPE press effect; negative values invert it. Beyond 100%, the full effect is reached with a smaller gesture |
| Layer 3/Config | MPE Slide Target | 578 | L3 MPE Slide Target | What MPE 'slide' (per-note CC74) controls on this layer. For Volume, the slide position acts as a fader up to the layer's volume level; other destinations are bipolar around slide's centre. Only active when MPE is enabled in Performance Controls |
| Layer 3/Config | MPE Slide Amount | 579 | L3 MPE Slide Amount | Intensity of the MPE slide effect; negative values invert it. Beyond 100%, the full effect is reached with a smaller gesture |
| Layer 3/LFO | Time (Tempo Synced) | 580 | L3Lfo Time (Tempo Synced) | LFO rate (synced to the host) |
| Layer 3/Arp | Rate | 581 | L3Arp Rate | Arpeggiator rate (synced to host tempo) |
...
| Effect/Delay | Time Left (Tempo Synced) | 146 | Dly Time Left (Tempo Synced) | Left delay time (synced to the host tempo) |
| Effect/Delay | Time Right (Tempo Synced) | 147 | Dly Time Right (Tempo Synced) | Right delay time (synced to the host tempo) |
