...
> Instruments are Floe's core building block
...
Instruments are loaded into any of Floe's 3 [layers](/docs/usage/layers) using a powerful _[browser](/docs/usage/browsers)_ which lets you easily find instruments across all your installed libraries. A layer that has no instrument loaded will say 'None' instead of the instrument name - click this to open the browser.
