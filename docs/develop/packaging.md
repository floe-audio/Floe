...
The easiest and most reliable way to distribute your Floe content is with [Floe Packages](/docs/installation/install-packages#what-is-a-package).
...
-   **Floe Packager Windows**: [Floe-Packager-v2.0.3-Windows.zip](https://github.com/floe-audio/Floe/releases/download/v2.0.3/Floe-Packager-v2.0.3-Windows.zip) (13 MB)
-   **Floe Packager macOS Apple Silicon**: [Floe-Packager-v2.0.3-macOS-Apple-Silicon.zip](https://github.com/floe-audio/Floe/releases/download/v2.0.3/Floe-Packager-v2.0.3-macOS-Apple-Silicon.zip) (1 MB)
-   **Floe Packager macOS Intel**: [Floe-Packager-v2.0.3-macOS-Intel.zip](https://github.com/floe-audio/Floe/releases/download/v2.0.3/Floe-Packager-v2.0.3-macOS-Intel.zip) (1 MB)
-   **Floe Packager Linux**: [Floe-Packager-v2.0.3-Linux.tar.gz](https://github.com/floe-audio/Floe/releases/download/v2.0.3/Floe-Packager-v2.0.3-Linux.tar.gz) (14 MB)
