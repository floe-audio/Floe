...
All packages must be compatible with the current Floe version and meet basic quality standards for audio, scripting, and presentation. Packages from larger-budget developers/studios may require [sponsorship](/docs/about-the-project/sponsorship).
