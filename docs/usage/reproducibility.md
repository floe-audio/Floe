...
Reproducibility settings live in the [Performance Controls](/docs/usage/performance-controls) panel.
...
-   Like the rest of the [Performance Controls](/docs/usage/performance-controls) panel, these settings belong to this specific instance and loading a preset leaves them untouched — so you can audition presets without losing your reproducibility setup.
