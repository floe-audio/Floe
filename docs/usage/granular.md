...
-   Selected from the **Play Mode** menu at the top of the layer's [Playback tab](/docs/usage/layers#playback-tab), alongside _Standard Playback_.
...
-   It's often interesting to control the Position (_Granular Fixed_ mode) using the LFO or a [macro](/docs/usage/macros) for added movement.
