    ...
    // in production builds.
    {
        ...
        if (targetCanRunNatively(cfg.target)) {
            ...
            const doc_screenshots = [_]DocScreenshot{
                ...
                .{ .id_name = "filter-collection" },
                .{ .id_name = "filter-collection-all-selected" },
                .{ .id_name = "filter-collection-folder-selected" },
                .{ .id_name = "filter-collection-folder-tree" },
                .{ .id_name = "browser-menu" },
                .{ .id_name = "browser-browse" },
                .{ .id_name = "browser-browse-section" },
                .{ .id_name = "browser-browse-collection" },
                .{ .id_name = "browser-browse-attribute" },
                .{ .id_name = "browser-preset-browse", .preset = "Drones/Faded Silhouettes.floe-preset" },
                .{
