...
fn doTarget(
    ...
    const vitfx = blk: {
        ...
        lib.addCSourceFiles(.{
            .files = &.{
                path ++ "/src/synthesis/effects/reverb.cpp",
                path ++ "/src/synthesis/effects/phaser.cpp",
                path ++ "/src/synthesis/effects/delay.cpp",
                path ++ "/src/synthesis/framework/processor.cpp",
                path ++ "/src/synthesis/framework/processor_router.cpp",
                path ++ "/src/synthesis/framework/value.cpp",
                path ++ "/src/synthesis/framework/feedback.cpp",
                path ++ "/src/synthesis/framework/operators.cpp",
                path ++ "/src/synthesis/filters/phaser_filter.cpp",
                path ++ "/src/synthesis/filters/synth_filter.cpp",
                path ++ "/src/synthesis/filters/sallen_key_filter.cpp",
                path ++ "/src/synthesis/filters/comb_filter.cpp",
                path ++ "/src/synthesis/filters/digital_svf.cpp",
                path ++ "/src/synthesis/filters/dirty_filter.cpp",
                path ++ "/src/synthesis/filters/ladder_filter.cpp",
                path ++ "/src/synthesis/filters/diode_filter.cpp",
                path ++ "/src/synthesis/filters/formant_filter.cpp",
                path ++ "/src/synthesis/filters/formant_manager.cpp",
                path ++ "/wrapper.cpp",
            },
            .flags = FlagsBuilder.init(build_context, target, .{
                .compile_commands = concat_cdb,
